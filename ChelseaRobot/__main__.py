...
I'm a Powerfull group manager bot With Cool Modules. Made By @ItzMe_Anon
hit /help to Find my list of available commands 🕹*
"""

buttons = [
    [
        InlineKeyboardButton(text="📌Updates Channel", url="https://t.me/ChelseaRobotUpdates"),
        InlineKeyboardButton(text="🖲 Support Group", url="https://t.me/ChelseaRobotSupport"),
    ],
   # [
  ...
  #  ],
    [
        InlineKeyboardButton(
            text="➕ Add Chelsea Robot To Youre Group ➕", url="t.me/Chelsea_Robot?startgroup=true"
        ),
    ],
]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ChelseaRobot.modules." + module_name)
...
def ChelseaRobot_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Chelsea Updates.* "
            f"\n\n Join [Chelsea Updates](https://t.me/ChelseaRobotUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Chelsea Support](https://t.me/ChelseaRobotSupport).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is the best version of Chelsea for the best performance.*"
            f"\n\nBased on [Chelsea Robot](https://t.me/Chelsea_Robot)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by Anon"
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        ChelseaRobot_about_callback, pattern=r"aboutmanu_"
    )
