...
import KensurRobot.modules.sql.notes_sql as sql
from KensurRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KensurRobot.__main__ import DATA_IMPORT
from KensurRobot.modules.helper_funcs.chat_status import user_admin
from KensurRobot.modules.helper_funcs.alternate import typing_action

# from KensurRobot.modules.rules import get_rules
import KensurRobot.modules.sql.rules_sql as rulessql

# from KensurRobot.modules.sql import warns_sql as warnssql
import KensurRobot.modules.sql.blacklist_sql as blacklistsql
from KensurRobot.modules.sql import disable_sql as disabledsql

# from KensurRobot.modules.sql import cust_filters_sql as filtersql
# import KensurRobot.modules.sql.welcome_sql as welcsql
import KensurRobot.modules.sql.locks_sql as locksql
from KensurRobot.modules.connection import connected
...
def export_data(update: Update, context: CallbackContext):
    ...
    with open("KensurRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KensurRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KensurRobot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KensurRobot{}.backup".format(chat_id))  # Cleaning file
