...
import KensurRobot.modules.sql.connection_sql as sql
from KensurRobot import dispatcher, SUDO_USERS, DEV_USERS
from KensurRobot.modules.helper_funcs import chat_status
