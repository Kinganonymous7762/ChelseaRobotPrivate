...
import KensurRobot.modules.sql.feds_sql as sql
...
from KensurRobot.modules.helper_funcs.string_handling import markdown_parser
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        fed_name = info["fname"]
        # https://t.me/KensurRobotSupport/41606 // https://t.me/KensurRobotSupport/41619
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "KensurRobot_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="KensurRobot_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "KensurRobot_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="KensurRobot_fbanned_users.csv",
