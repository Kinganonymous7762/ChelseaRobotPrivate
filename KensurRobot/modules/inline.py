...
import KensurRobot.modules.sql.users_sql as sql
...
from KensurRobot.modules.helper_funcs.misc import article
from KensurRobot.modules.helper_funcs.decorators import kensurinline
    ...
    inline_help_dicts = [
        {
            ...
            "thumb_urL": "https://te.legra.ph/file/37ec9b49cfa7e5ae07d34.jpg",
            "keyboard": ".spb ",
        },
        {
            "title": "Account info on Chelsea",
            "description": "Look up a Telegram account in Chelsea database",
            "message_text": "Click the button below to look up a person in Chelsea database using their Telegram ID",
            "thumb_urL": "https://te.legra.ph/file/37ec9b49cfa7e5ae07d34.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Chelsea",
            "message_text": "Click the button below to get to know about Chelsea.",
            "thumb_urL": "https://te.legra.ph/file/37ec9b49cfa7e5ae07d34.jpg",
            "keyboard": ".about ",
        },
        {
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error",
                    url=f"https://t.me/ChelseaRobotSupport",
                ),
                InlineKeyboardButton(
                    text="Search again",
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    Chelsea_Robot (@{context.bot.username})
    Maintained by [Anon🇮🇳](t.me/ItzMe_Anon)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/ChelseaRobotUpdates",
                ),
                InlineKeyboardButton(
                    text='Ping',
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Chelsea_Robot (@{context.bot.username})",
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error",
                    url=f"https://t.me/ChelseaRobotDupport",
                ),
                InlineKeyboardButton(
                    text="Search again",
