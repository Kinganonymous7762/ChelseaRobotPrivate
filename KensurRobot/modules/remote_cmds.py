from KensurRobot import dispatcher
...
from KensurRobot.modules.helper_funcs.extraction import extract_user_and_text
...
def banall(update, context):
    ...
    for mems in all_mems:
        try:
            ...
            update.effective_message.reply_text("Banning...")
            sleep(1.0)
        except BadRequest as excp:
...
RAIDBAN_HANDLER = CommandHandler("raidBan", banall, filters=CustomFilters.sudo_filter, run_async=True)
...
dispatcher.add_handler(RAIDBAN_HANDLER)
