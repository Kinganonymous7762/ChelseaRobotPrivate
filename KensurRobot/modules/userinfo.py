...
from KensurRobot.modules.sql import SESSION
from KensurRobot.__main__ import STATS, GDPR, TOKEN, USER_INFO, get_readable_time
import KensurRobot.modules.sql.userinfo_sql as sql
import KensurRobot.modules.sql.users_sql as sqldb
from KensurRobot.modules.disable import DisableAbleCommandHandler
from KensurRobot.modules.sql.global_bans_sql import is_user_gbanned
from KensurRobot.modules.sql.afk_sql import is_afk, check_afk_status
from KensurRobot.modules.sql.users_sql import get_user_num_chats
from telegram import __version__ as ptbver, InlineKeyboardMarkup, InlineKeyboardButton
from KensurRobot.modules.sql.clear_cmd_sql import get_clearcmd
from KensurRobot.modules.helper_funcs.chat_status import sudo_plus
from KensurRobot.modules.helper_funcs.extraction import extract_user
from KensurRobot.modules.helper_funcs.misc import delete
from KensurRobot import telethn as KensurRobotTelethonClient, SUDO_USERS, SUPPORT_USERS
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += '\nThis Person is a part of team chelsea'
        disaster_level_present = True
        ...
        if disaster_level_present:
            text += ' [<a href="https://t.me/ChelseaRobotUpdates">?</a>]'.format(
                bot.username)
...
def gdpr(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not KensurRobot data. "
