...
import telegram
from KensurRobot import WHITELIST_USERS, dispatcher
...
from KensurRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from KensurRobot.modules.helper_funcs.string_handling import split_quotes
from KensurRobot.modules.log_channel import loggable
from KensurRobot.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # KensurRobot's sticker
        keyboard = None
        log_reason = (
