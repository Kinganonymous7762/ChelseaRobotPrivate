...
import KensurRobot.modules.sql.welcome_sql as sql
import KensurRobot
...
from KensurRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from KensurRobot.modules.helper_funcs.misc import build_keyboard, delete, revert_buttons
from KensurRobot.modules.helper_funcs.msg_types import get_welcome_type
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not KensurRobot.ALLOW_CHATS:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Thanks for adding me! Join @ChelseaRobotUpdates for Support", reply_to_message_id=reply
                )
                continue
