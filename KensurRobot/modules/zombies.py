...
from KensurRobot import telethn as KensurRobotTelethonClient
from KensurRobot.modules.sql.clear_cmd_sql import get_clearcmd
from KensurRobot.modules.helper_funcs.telethn.chatstatus import user_is_admin
from KensurRobot.modules.helper_funcs.misc import delete


@KensurRobotTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
